...
nucleosynthesis to the timescales of different types of supernovae. The $\alpha$-elements that the authors are interested 
in are carbon, oxygen, neon, magnesium, silicon, sulfur, argon, and calcium.
...
the authors collected data on the abundance of iron (Fe I and Fe II), carbon, $\alpha$-elements, neutron-capture elements, and other 
lighter elements. The authors then compared this data to stars found in classical dSph galaxies and the Milky Way halo.
...
In the three lowest metallicity stars, out of the six observed stars, the abundance of iron (both Fe I and Fe II) indistinguishable
